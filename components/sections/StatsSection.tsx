  ...
  return (
    <section className="py-16 sm:py-20 md:py-24 relative">
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 50% at 50% 50%, rgba(0,107,189,0.06) 0%, transparent 70%)',
        }}
      />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          {stats.map((stat, i) => (
            <AnimatedSection key={stat.label} delay={i * 0.1} direction="up">
              <div
                className="p-6 sm:p-8 rounded-2xl text-center group hover:scale-105 transition-all duration-300"
                style={{
              ...
              >
                ...
                <h3 className="font-semibold text-sm mb-1" style={{ color: 'var(--text)' }}>{stat.label}</h3>
